...
constexpr int kSpecializedM = 128;
constexpr int kSpecializedSplitK = 4;
...
__global__ void __launch_bounds__(kThreads, 1) nvfp4_m128_partial_kernel(
...
__global__ void reduce_m128_splitk_kernel(
...
GemmStatus launch(
  ...
  auto partial_kernel =
      nvfp4_m128_partial_kernel<Config, decltype(tma_partial_output)>;
  constexpr int kPartialOutputSmemOffset =
